...
void ui_home_screen_init(void)
{
    ...
    lv_label_set_text(ui_Label3, "DONNEES");
    ...
    lv_obj_set_style_bg_color(ui_Button2, lv_color_hex(0xE05624), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_Label1, "COMMANDES");

    ui_Button3 = lv_btn_create(ui_home);
    lv_obj_set_width(ui_Button3, 145);
    ...
    lv_label_set_text(ui_Label2, "REGLAGES");
